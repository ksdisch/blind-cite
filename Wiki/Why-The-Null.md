...
- **Unresolved — and now the largest one (D25)**: why the extension pairs elicit materially more engagement than M1's (35% → 55–65% at the adversarial cell). The pairs differ only in hand-authored themes and generated prose. This confounds any reading of the M1-vs-M1C difference that is not purely about N.
