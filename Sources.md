...
| Target paper | arXiv 2607.09349 (Caruzzo, Yoo, Kim), v1 2026-07-10 (re-read in full 2026-08-03: still v1, no code) | external paper (no code shipped) | The deceptive-grounding claim being reproduced; directional anchors only, never point-estimate targets. §4 Cy definitions, Table 1 per-cell rates (calibration model), Table 2 cross-model **peak** rates, Appendix A synthetic_Y construction, limitations |
| Paper cell mapping | `Wiki/Paper-Mapping.md` | synthesis of the 2026-08-03 re-read | Which paper cell our factorial corresponds to; the withdrawn 66.3% comparison; the parametric-prior explanation for the null |
