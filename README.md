...
M1 spend $0.0177 (cap $0.45); project total ≈$0.027. **v1 does not close here (D19 supersedes D15):** the pre-registered, power-sized extension on `qwen-2.5-7b` is committed ([`docs/M1C-BRIEF.md`](docs/M1C-BRIEF.md), D23); build awaits go-ahead. Results: [`docs/M1-BRIEF.md`](docs/M1-BRIEF.md) ("M1 outcome" addendum), [`Wiki/Results.md`](Wiki/Results.md), and the machine-rendered [`data/m1a_verdict.json`](data/m1a_verdict.json) / [`data/m1b_verdict.json`](data/m1b_verdict.json). Source of truth: [`docs/KICKOFF.md`](docs/KICKOFF.md).
